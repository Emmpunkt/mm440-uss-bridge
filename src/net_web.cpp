...
window.LANG='de';
const I18N={de:{title:"MM440 Einstellungen",back:"← zurück",device:"Gerät",name:"Name (HA-Anzeigename)",langlabel:"Sprache / Language",wlan:"WLAN",pass:"Passwort",unchanged:"leer = unverändert",set:"(gesetzt)",mqtt:"MQTT",mqtthint:"(Host leer = deaktiviert)",user:"Benutzer",uss:"USS / Antrieb",addr:"USS-Adresse (0-31)",reffreq:"Bezugsfrequenz P2000 (Hz)",spmin:"Sollwert min (Hz)",spmax:"Sollwert max (Hz)",save:"Speichern & Neustart",freset:"Werkseinstellungen",savedok:"Gespeichert. Neustart läuft …",saveerr:"Fehler",fconfirm:"Wirklich auf Werkseinstellungen zurücksetzen?",fmsg:"Zurückgesetzt. Neustart (AP-Modus) …"},en:{title:"MM440 Settings",back:"← back",device:"Device",name:"Name (HA display name)",langlabel:"Language / Sprache",wlan:"Wi-Fi",pass:"Password",unchanged:"empty = unchanged",set:"(set)",mqtt:"MQTT",mqtthint:"(host empty = disabled)",user:"User",uss:"USS / Drive",addr:"USS address (0-31)",reffreq:"Reference frequency P2000 (Hz)",spmin:"Setpoint min (Hz)",spmax:"Setpoint max (Hz)",save:"Save & restart",freset:"Factory reset",savedok:"Saved. Restarting …",saveerr:"Error",fconfirm:"Really reset to factory defaults?",fmsg:"Reset. Restarting (AP mode) …"}};
function t(k){return (I18N[window.LANG]||I18N.de)[k]||k;}
